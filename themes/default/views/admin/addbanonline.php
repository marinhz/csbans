...
function playeraction(action, player, server)
{
	...
	if(action == "ban")
	{
		var reason = prompt("Въведете причината за забраната", "Чийтър");
		if(!reason)
		...
		if(!bantime)
			return alert("Въведете срок за забрана!");
	}
