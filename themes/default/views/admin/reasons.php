...
$this->menu=array(
	array('label'=>'Добавете група причини','url'=>array('/reasonsSet/create')),
	array('label'=>'Добавете причина','url'=>array('/reasons/create')),
);
...
<h4>Група причини</h4>
<small class="text-success">Кликнете върху група за редактиране</small>
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'type' => 'bordered condensed striped',
	'id'=>'reasonsset-grid',
	'dataProvider'=>$reasonsset,
	//'summaryText' => 'Показани от {start} до {end} причин из {count}. Страница {page} от {pages}',
