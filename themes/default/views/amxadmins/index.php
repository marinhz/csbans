...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
	...
	'summaryText' => 'Показани от {start} до {end} администратори от {count}. Страница {page} от {pages}',
	'enableSorting' => false,
...
<div class="modal-header">
    ...
    <h4>Подробности за администратора</h4>
</div>
<div class="modal-body" style="min-height: 450px">
	...
	<hr>
	<h3>Администратор на сървъри</h3>
...
<div id="info_access" class="row-fluid" style="display: none">
	...
	<div class="span6">
		...
		a - Кика играч при въвеждане на неправилна парола<br />
		b - Етикет на клана<br />
		c - За SteamID<br />
		d - За IP<br />
		e - Не се изисква парола (важни са само SteamID или IP)<br />
		k - Име или етикет (без значение за малки и големи букви!).
	</div>
</div>