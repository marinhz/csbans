...
return array (
  ...
  'The attribute must be specified in the format of "Name:Type:Label", where "Type" and "Label" are optional.' => 'Атрибут должен быть указан в формате "Име:Тип:Заголовок". "Тип" и "Заголовок" не обязательны.',
