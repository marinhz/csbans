...
return array (
  ...
  'CDbConnection is unable to find PDO class "{className}". Make sure PDO is installed correctly.' => 'CDbConnection не удалось найти класс PDO "{className}". Убедитесь, что PDO инсталиран и настроен.',
  ...
  'Column name must be either a string or an array.' => 'Име столбца должно быть строкой или массивом.',
  ...
  'Error: Table "{table}" does not have a primary key.' => 'Грешка: В таблице "{table}" отсутствует первичный ключ.',
  'Error: Table "{table}" has a composite primary key which is not supported by crud command.' => 'Грешка: Таблица "{table}" содержит составной первичный ключ, работа с которым не поддерживается командами CRUD.',
  ...
  'Invalid MO file: {file} (magic: {magic}).' => 'Грешка в MO файле: {file} (магия: {magic}).',
  ...
  'Next &gt;' => 'Следующая &gt;',
  'No' => 'Не',
  'No columns are being updated for table "{table}".' => 'Не столбцов подлежащих обновлению в таблице "{table}".',
  'No counter columns are being updated for table "{table}".' => 'Не столбцов-счетчиков подлежащих обновлению в таблице "{table}".',
