...
class Levels extends CActiveRecord
{
	...
	public function afterSave() {
		if($this->isNewRecord)
			Syslog::add(Logs::LOG_ADDED, 'Добавлен новый ниво веб админов');
		else
			Syslog::add(Logs::LOG_EDITED, 'Изменены ниво веб админов № <strong>' . $this->level . '</strong>');
		return parent::afterSave();
	}

	public function afterDelete() {
		Syslog::add(Logs::LOG_DELETED, 'Удален ниво веб админов № <strong>' . $this->level . '</strong>');
