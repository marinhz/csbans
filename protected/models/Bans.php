 ...
 * @property integer $ban_kicks Кол-во кикове
...
class Bans extends CActiveRecord
{
	...
	protected function beforeValidate() {
		if($this->isNewRecord) {
			...
			{
				return $this->addError($this->player_ip, 'Этот IP уже забранен');
			}
			...
			{
				return $this->addError($this->player_id, 'Этот STEAMID уже забранен');
			}
		}
