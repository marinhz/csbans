...
<div class="modal-header">
    ...
    <h4>Подробности за сървъра <a id="serverlink" rel="tooltip" data-placement="bottom" data-title="Покажи детайли"></a></h4>
</div>
	...
	<div class="row-fluid">
			...
			<div class="span6">
				...
				<div id="server-links" class="text-center">
					<a id="steam-connect" title="Свържете се">
	...
	<?php foreach($servers as $server):?>
		$.post(
			...
			function(data){
				...
				if(!info)
				{
					ret = '<td colspan="7"><?php echo $server['hostname']?> <b>Не отговаря</b></td>';
					elem.addClass('error');
				}
				else
				{
