...
<?php echo CHtml::link('Търсене','#',array('class'=>'search-button btn btn-small')); ?>
...
$this->widget('bootstrap.widgets.TbGridView', array(
	...
	'summaryText' => 'Показани от {start} до {end} забрани от {count}. Страница {page} от {pages}',
	'htmlOptions' => array(
		'style' => 'width: 100%'
	),
    ...
    'columns'=>array(
		...
		array(
			'header' => 'Срок',
			'value' => '$data->ban_length == \'-1\' ? \'Незабранен\' : Prefs::date2word($data->ban_length) . ($data->expired == 1 ? \' (истек)\' : \'\')',
