...
$this->widget('bootstrap.widgets.TbTabs', array(
	...
	'tabs' => array(
		array(
			...
			'content' => '
				<ul class="inline">
					...
					<li><a href="' . Yii::app()->createUrl('/admin/addbanonline') . '" class="btn"'.($activebtn == 'addbanonline' ? $disabled : '').'>Добави бан онлайн</a></li>
				</ul>',
			'active' => $active == 'main'
		),
		array(
		...
		array(
			...
			'content' => '
				<ul class="inline">
					<li><a href="' . Yii::app()->createUrl('/webadmins/admin') . '" class="btn"'.($activebtn == 'webadmins' ? $disabled : '').'>ВЕБ админ</a></li>
